...
const faqs = [
  {
    ...
    a: 'لا. زيت Veluna كيساعد يزيل الشعر من سطح البشرة بطريقة أسهل وألطف، وماشي منتج لإيقاف نمو الشعر نهائياً. النتائج كتختلف من بشرة لبشرة.',
  },
  {
  ...
  {
    q: 'كيفاش نستعمل روتين Veluna بشكل صحيح؟',
