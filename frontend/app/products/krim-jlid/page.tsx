  ...
  const gallery = [
    {
      ...
      alt:        'كريم الشعر تحت الجلد Veluna — صورة المنتج',
      bg:         'from-[#F8EEF5] to-[#FDF6FA]',
      pad:        'p-6',
      thumbCover: false,
    },
    {
      src:        '/products/cream-2.jpg',
      alt:        'روتين Veluna الكامل — الكريم والزيت معاً',
      bg:         'from-[#F8EEF5] to-[#F0E8F2]',
      pad:        'p-0',
      thumbCover: true,
    },
  ]
